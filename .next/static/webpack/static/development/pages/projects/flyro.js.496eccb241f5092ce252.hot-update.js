...
var ProjectDetailItem = function ProjectDetailItem(props) {
  ...
  Object(_utils_hooks_useComponentDidMount__WEBPACK_IMPORTED_MODULE_5__["useComponentDidMount"])(function () {
    document.onscroll = function () {
      if (videoRef.current.getBoundingClientRect().top < 500) {
        if (!played.current) {
          videoRef.current.play();
          played.current = true;
        }
      } else if (videoRef.current.getBoundingClientRect().top < 0) {
        if (played.current) {
...
//# sourceMappingURL=flyro.js.496eccb241f5092ce252.hot-update.js.map