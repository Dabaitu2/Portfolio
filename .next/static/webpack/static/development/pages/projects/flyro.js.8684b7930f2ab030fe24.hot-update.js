...
var ProjectDetailItem = function ProjectDetailItem(props) {
  ...
  }), window && video ? video.map(function (v) {
    return __jsx("div", {
      style: {
        width: '1600rem'
      },
      ...
      src: v.src,
      poster: window.isWebP ? images[0].sources[0].src : images[0].src,
      ref: videoRef,
      autoPlay: false,
      controls: true,
      style: {
...
//# sourceMappingURL=flyro.js.8684b7930f2ab030fe24.hot-update.js.map